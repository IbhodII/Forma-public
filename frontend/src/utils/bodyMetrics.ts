...
export const BODY_METRIC_FORM_SECTIONS: BodyMetricFormSection[] = [
  {
    ...
    columns: 3,
    fields: [
      { key: "weight_kg", label: "Вес, кг", max: 300, unit: "кг" },
      { key: "body_fat_percent", label: "Жир, %", max: 60, unit: "%" },
      { key: "muscle_mass_kg", label: "Мышцы, кг", max: 150, unit: "кг" },
    ],
  },
  {
    title: "Грудь",
    ...
    columns: 2,
    fields: [
      { key: "chest_inhale_cm", label: "Вдох, см", max: 200, unit: "см" },
      { key: "chest_exhale_cm", label: "Выдох, см", max: 200, unit: "см" },
    ],
  },
  {
    title: "Руки",
    ...
    columns: 5,
    fields: [
      { key: "bicep_relaxed_cm", label: "Бицепс Р", max: 80, unit: "см" },
      { key: "bicep_tense_cm", label: "Бицепс Н", max: 80, unit: "см" },
      { key: "forearm_relaxed_cm", label: "Предпл. Р", max: 80, unit: "см" },
      { key: "forearm_tense_cm", label: "Предпл. Н", max: 80, unit: "см" },
      { key: "wrist_cm", label: "Запястье", max: 80, unit: "см" },
    ],
  },
  {
    title: "Ноги",
    columns: 5,
    fields: [
      { key: "thigh_relaxed_cm", label: "Бедро Р", max: 120, unit: "см" },
      { key: "thigh_tense_cm", label: "Бедро Н", max: 120, unit: "см" },
      { key: "calf_relaxed_cm", label: "Икра Р", max: 80, unit: "см" },
      { key: "calf_tense_cm", label: "Икра Н", max: 80, unit: "см" },
      { key: "ankle_cm", label: "Лодыжка", max: 80, unit: "см" },
    ],
  },
  {
    ...
    columns: 3,
    fields: [
      { key: "waist_cm", label: "Талия, см", max: 200, unit: "см" },
      { key: "hips_cm", label: "Бёдра, см", max: 200, unit: "см" },
      { key: "neck_cm", label: "Шея, см", max: 80, unit: "см" },
    ],
  },
];
...
export function formatBodyDetailValue(
  ...
  if (key === "muscle_mass_kg") return units.formatBarbellWeight(n);
...
export function calcMetricDelta(
  ...
  if (Math.abs(diff) < 0.05) return { diff: 0, pct: 0, improved: true };
